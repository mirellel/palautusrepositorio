...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostetaan_kaksi_tuotetta_joista_toista_ei_ole_saldolla(self):
    ...
    def test_asioinnin_aloittaminen_nollaa_tiedot(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_tuoteet_voi_poistaa_korista(self):
